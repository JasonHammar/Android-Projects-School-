...
public class ThreadedDownloadActivity extends AppCompatActivity {
    ...
    private ThreadedDownloadActivity.ThreadHandler handler;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        handler = new ThreadedDownloadActivity.ThreadHandler(urlImage);
        Button runnable = (Button) findViewById(R.id.runnable);

        runnable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ThreadedDownloadActivity.RunnableDownload runnable = new ThreadedDownloadActivity.RunnableDownload();
        ...
        message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ThreadedDownloadActivity.MessagesDownload messages = new ThreadedDownloadActivity.MessagesDownload();
    ...
    public void displayWarning(){
        runOnUiThread(new Runnable() {
            public void run()
            {
                Toast.makeText(ThreadedDownloadActivity.this,"Error, Could Not Download, Please enter correct URL",Toast.LENGTH_LONG).show();
    ...
    public void runAsyncTask(String view) {
        ...
        ThreadedDownloadActivity.AsyncDownload asyncDownload = new ThreadedDownloadActivity.AsyncDownload();
    ...
    private class AsyncDownload extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ThreadedDownloadActivity.this);
